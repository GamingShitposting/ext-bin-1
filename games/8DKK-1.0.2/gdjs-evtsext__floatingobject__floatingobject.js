...
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(54033844);
}
...
, "Tween": this._getTween()
  ...
  globalVariablesForExtension: runtimeScene.getGame().getVariablesForExtension("FloatingObject"),
  sceneVariablesForExtension: runtimeScene.getScene().getVariablesForExtension("FloatingObject"),
  localVariables: [],
